package com.valspar.interfaces.regulatory.msdsrequest.program;
...
import com.valspar.interfaces.regulatory.msdsrequest.beans.*;
import java.io.*;
import java.sql.*;
...
public class MsdsRequestInterface extends BaseInterface
{
  ...
  public void processRequestBeans(ArrayList<RequestBean> requestBeanList)
  {
    try
    {
      ...
      for (RequestBean requestBean: requestBeanList)
      {
        ...
        {
          if (requestBean.getFileList().size() != 0)
          {
  ...
  public void writePDFFiles(RequestBean rb)
  {
    ...
    try
    {
      pstmt = regulatoryConn.prepareStatement(sb.toString());
  ...
  public void writeQuickFdsPDFFiles(RequestBean rb)
  {
    ...
    StringBuilder sb = new StringBuilder();
    sb.append("SELECT replace(replace(A.F_PRODUCT,'/'),'\\'), DECODE(A.F_SUBFORMAT,'PDS','CPDS',A.F_SUBFORMAT), A.F_LANGUAGE, F_PDF ");
    sb.append("from t_pdf_msds a, t_product_alias_names n, t_prod_data t , t_prod_data t2, vca_msds_request_queue q, vca_lookups v1, vca_lookups v2 ");
    sb.append("where  a.f_product = n.f_product  ");
    sb.append("and    n.f_product = t.f_product  ");
    sb.append("and    n.f_product = t2.f_product ");
    sb.append("and    q.request_id = ? ");
    sb.append("and    v1.keyfield1 = 'QUICKFDS_SUBFORMAT' ");
    sb.append("and    v2.keyfield1 = 'QUICKFDS_EXTN'  ");
    sb.append("and    a.F_AUTHORIZED <> 0  ");
    sb.append("and    t.f_data_code = 'EXTN'  ");
    sb.append("and    t.f_data = v2.keyfield2 ");
    sb.append("and    a.f_subformat = v1.keyfield2  ");
    sb.append("and    t2.f_data_code = 'FRMCLS' ");
    sb.append("and    t2.f_data <> 'I' ");
    sb.append("and    n.f_alias not like '%.%' ");
    sb.append("and    t.f_product not like '92%' ");
    sb.append("and    t.f_product not like 'T-%' ");
    ...
    try
    {
      ...
      while (rs.next())
      {
        ...
        if (StringUtils.equalsIgnoreCase(subformat, "CLP1"))
        {
          subformatDirectoryString = subformat + File.separator + language;
        }
        else
        {
