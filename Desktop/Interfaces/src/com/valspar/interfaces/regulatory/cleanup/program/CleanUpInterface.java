package com.valspar.interfaces.regulatory.cleanup.program;
...
public class CleanUpInterface extends BaseInterface
{
  ...
  {
    log4jLogger.info("Running WERCS_CLEANUP_INTERFACE_PROC in " + DataSource.REGULATORY.getDataSourceLabel() + "...");
    ...
    try
    {
      ...
      if (cstmt.getString(1) != null)
        log4jLogger.info("Error Running WERCS_CLEANUP_INTERFACE_PROC in " + DataSource.REGULATORY.getDataSourceLabel() + ": " + cstmt.getString(1));
      else
        log4jLogger.info("Done Running WERCS_CLEANUP_INTERFACE_PROC in " + DataSource.REGULATORY.getDataSourceLabel());
    }
    catch (Exception e)
    {
      log4jLogger.error(e);
