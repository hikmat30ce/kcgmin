...
public class GLStatBean
{
  ...
  private String companyCode;   //segment1 from analytics
  private String profitCenter;  //segment2 from analytics
  private String location;      //segment3 from analytics
  private String costCenter;    //segment4 from analytics
  private String account;       //segment5 from analytics
  ...
  public void setEnteredDR(String enteredDR)
  {
    this.enteredDR = enteredDR;
  }

  public String getEnteredDR()
  {
    return enteredDR;
  }

  public void setEnteredCR(String enteredCR)
  {
    this.enteredCR = enteredCR;
  }

  public String getEnteredCR()
  {
    return enteredCR;
  }
